...
--
CREATE FUNCTION to_kbpo_type(x TEXT) RETURNS TEXT AS $$
BEGIN
    CASE x
        WHEN 'PERSON' THEN RETURN 'PER';
        WHEN 'ORGANIZATION' THEN RETURN 'ORG';
        WHEN 'GPE' THEN RETURN 'GPE';
        WHEN 'CITY' THEN RETURN 'GPE';
        WHEN 'STATE_OR_PROVINCE' THEN RETURN 'GPE';
        WHEN 'COUNTRY' THEN RETURN 'GPE';
        WHEN 'LOCATION' THEN RETURN 'GPE';
...
STRICT
;
COMMENT ON FUNCTION to_kbpo_type(TEXT) IS 'Converts type to KBPO type.';
