...
We analyze submissions over the last \todo{4} years to the TAC-KBP challenge and find the current dataset-driven evaluation methodology to be inadequate in confirming measured improvements to statistical validity due its small size.
