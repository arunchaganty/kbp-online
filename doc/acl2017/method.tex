...
In the knowledge base population task,
 ...
 \pl{sounds like it's meant to be a formal definition, but you can't define it formally
 because you haven't defined entities and relations;
 probably better to start with the intuitive example first}
...
Finally, when returning entity mentions and relations, the surrounding context $c$ \pl{not clear what this encompasses} used to justify the link or relation must also be specified.
