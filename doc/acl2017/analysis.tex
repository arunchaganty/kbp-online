\section{Measuring bias due to the closed world assumption}
\label{sec:analysis}
%(2 pages)
...
Without the \texttt{anydoc} heuristic, pooling bias is 15.51\% \fone{} points and with the heuristic it is 1.98\% \fone{} points.
