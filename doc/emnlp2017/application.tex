...
\reffig{entity-distribution} plots a histogram of different predicates and entities are represented by the uniform, predicate and subject distributions.
...
When verifying relational tuples predicted by a system, 
  crowd workers are presented the tuple's provenance and are asked to identify if a relation holds between the identified subject and object mentions (\figureref{relation-interface}). 
