...
Our goal for the on-demand evaluation service we have implemented is to ensure that KBP systems are fairly evaluated on diverse subjects and predicates.
At the same time, we would like to ensure that entities with multiple relations are represented to measure completeness of knowledge base entries.
...
See \refapp{implementation} for an analysis of this distribution and other potential choices.} 
\begin{align*}
