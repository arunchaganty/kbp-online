...
We label predicted relation instances by presenting the instance's provenance to crowdworkers
  ...
  Crowd workers are also asked to link the subject and object mentions \ap{undefined; to their canonical mentions within the document and } to pages on Wikipedia, if possible, for entity linking.
