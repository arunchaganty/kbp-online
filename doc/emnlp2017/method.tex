...
We can measure how well the current evaluation set covers the predictions $X_m$ by using an upper bound on the variance of $\pih_m^{\text{(joint)}}$.\footnote{Further details can be found in \refapp{sampling} of the supplementary material.}
