...
Our first contribution is a new importance-sampling based evaluation which corrects for bias by annotating new system's predictions on-demand via crowdsourcing.
We show this eliminates bias and reduces variance on a simulation of the 2015 TAC KBP task. % as compared to standard evaluation.
...
We use the evaluation service to run three diverse state-of-the-art systems on the TAC KBP 2016 corpus, and demonstrate that the evaluation permits
an accurate quantitative and qualitative understanding of system performance \pl{can we make this less vague but not longer?}.
