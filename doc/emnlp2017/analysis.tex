...
\begin{figure}[t]
  ...
  \pl{should probably say that the bias is much smaller with \anydoc{} - the fact that wasn't mentioned made me confused because of pragmatics}
...
In total, there are 70 system submissions from 18 teams for 317 query entities \pl{this is $E$?} and the evaluation set consists of 11,008 labeled relation instances.\footnote{%
