...
The key finding of this paper contradicts this assumption and shows that the pooling bias is indeed significant, penalizing newly developed systems by 2\% \fone{} on average (\refsec{analysis}). 
...
Instead, in \refsec{method}, we propose a new evaluation methodology: on-demand evaluation.
