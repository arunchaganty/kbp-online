...
The discrepancy between a system's true score and the score on pooled dataset is called pooling bias and is typically assumed to be insignificant in practice \pl{any citations or quotes backing this assumption?}.
...
We simulate our method on evaluation data released through the TAC KBP 2015 Slot Validation track and show that we are able to obtain unbiased estimates of system scores while reducing variance.
