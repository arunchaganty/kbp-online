...
\entity{Carrie Fisher} and \entity{Debbie Reynolds} are respectively identified as the subject and object of the relation \relation{child of} in the given sentence.
...
The annotators judge whether or not the predicted relations actually hold given the specified provenance; even if a tuple specifies a true relation, e.g.\ (\entity{Carrie Fisher}, \relation{child of}, \entity{Debbie Reynolds}), from a ambiguous sentence, e.g.\ ``Carrie Fisher and Debbie Reynolds arrived together at the awards show'', it is marked incorrect.
