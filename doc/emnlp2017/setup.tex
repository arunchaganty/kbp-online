...
Separately, a team of annotators identify and label correct relation instances for the same evaluation entities $E$ by manually searching the document corpus within a time budget \citep{ellis2012kbp}.
